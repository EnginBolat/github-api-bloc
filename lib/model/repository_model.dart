...
class RepositoryModelResponse {
  List<RepositoryModel> listOfRepository;

  RepositoryModelResponse(this.listOfRepository);

  factory RepositoryModelResponse.fromJson(Map<String, dynamic> json) {
    var jsonArray = json as List;
    List<RepositoryModel> listOfRepository = jsonArray
        .map((jsonArrayNesnesi) => RepositoryModel.fromJson(jsonArrayNesnesi))
        .toList();

    return RepositoryModelResponse(listOfRepository);
  }
}
